...
module processor(
    ...
    data_readRegB,                  // I: Data from port B of regfile
	 //data_operandB,                used to test 
	 //data_result                   used to test
	 );
    ...
    /* YOUR CODE STARTS HERE */
	 ...
	 //output [31:0] data_operandB, data_result; //used for self-test
	 ...
	 assign shamt  = is_alu? q_imem[11:7] : 5'd0;  // alu if 1; R type
	 ...
	 assign sx_immed_N[31:16] = q_imem[16] ? 16'hFFFF:16'h0000; //if q_imem[16] is 1
	 assign sx_immed_N[15:0] = q_imem[15:0]; //I type
	
	 assign sx_immed_T[31:27] = 5'd0;//JI type unsigned
	 ...
	 assign is_ovf = (is_add | is_addi | is_sub) & overflow; // control signal for overflow
